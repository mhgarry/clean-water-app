...
const toggleVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap bg-transparent rounded-md text-sm font-bold transition-colors  duration-500 ring-offset-background focus-visible:outline-none px-2 py-2 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disable:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 w-1/3",
  {
    variants: {
      variant: {
        default:
